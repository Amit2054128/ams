...
<div class="left">
    ...
    <br>
    <div class="middle">
        <form action="search.php" method="post" style="margin-left:40%; margin-top:9%; color:white">
            <h3>Search by:</h3>
           
            <label for="id">Student id</label>&nbsp;
            <input type="text" name="stdId" id="stdId" style="border-radius:5 px; height:25px; width:190px;">&nbsp;&nbsp;
            <button name="search" style="height:39px; width:90px; color:white; background-color:#e6a12c; border-radius:12px;">Search</button>
        </form>
        <!-- <a href="form.php" style="text-decoration: none; color:azure; font-size:medium;"> <button style="margin-left:25%; margin-top:2%; height:50px; width:120px; background-color:#65858a; border-radius:12px">
                ADD MORE</a> -->
        </button>
        <table cellpadding="2" cellspacing="7" border="1" class="table" style="margin-left:25%; margin-top:3%; width:70%; color:aliceblue">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td><?php echo $res['std_id'] ?></td>
                        ...
                        <td><a class="text-decoration-none color-dark" style="color: white;  height:25px; width:120px;" href="edit.php?id=<?php echo $res['std_id']; ?> "><i class="fa fa-edit"></i></a></td>
                        <td><a class="text-decoration-none color-dark" style="color: white;  height:25px; width:120px;" href="remove.php?id=<?php echo $res['std_id']; ?> "><i class="fa fa-trash"></i></a></td>
                    </tr>
                <?php
                }

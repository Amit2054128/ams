...
<div class="left">
    ...
    <br>
    <div class="middle">
        <a href="aform.php" style="text-decoration: none; color:azure; font-size:medium;"> <button style="margin-left:25%; margin-top:2%; height:50px; width:120px; background-color:#65858a; border-radius:12px">
                ADD MORE</a>
        </button>
        <table cellpadding="25" cellspacing="2" border="1" class="table" style="margin-left:25%; margin-top:2%; width:70%; color:aliceblue">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td><?php echo $res['admin_id'] ?></td>
                        ...
                        <td><?php echo $res['admin_address'] ?></td>
                        <td><?php echo $res['admin_phone'] ?></td>
                        <td><?php echo $res['admin_username'] ?></td>
                        <td><?php echo $res['admin_password'] ?></td>

                        <td><a class="text-decoration-none color-dark" style="color: white;  height:25px; width:120px;" href="aedit.php?aedit=<?php echo $res['admin_id']; ?> "><i class="fa fa-edit"></i></a></td>
                        <td><a class="text-decoration-none color-dark" style="color: white;  height:25px; width:120px;" href="remove.php?adelete=<?php echo $res['admin_id']; ?> "><i class="fa fa-trash"></i></a></td>
                    </tr>
                <?php
                }
